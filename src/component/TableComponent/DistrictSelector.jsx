      ...
      <div className="row row-cols-2 row-cols-md-3 g-4">
        {districts.map((district) => (
          <div className="col" key={district.code}>
            <div className="card h-100" style={{color:"#166539", boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.15)"}} onClick={() => onSelect({ type: "district", body :  {type : "DistrictCommodityGird", code : district.code}})}>
